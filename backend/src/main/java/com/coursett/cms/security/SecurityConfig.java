    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/attendance/mark").hasAnyRole("ADMIN", "FACULTY", "HOD")
                        .requestMatchers(HttpMethod.GET, "/api/attendance/course/**").hasAnyRole("ADMIN", "FACULTY", "HOD")
                        .requestMatchers(HttpMethod.GET, "/api/attendance/export").hasAnyRole("ADMIN", "FACULTY", "HOD")
